...
class TestValidationRuleEngine(unittest.TestCase):
    ...
    def test_create_required_validator(self):
        ...
        self.assertFalse(result.is_valid)
        self.assertIn("字段不能为空", result.get_error_messages())
    ...
    def test_create_length_validator(self):
        ...
        self.assertFalse(result.is_valid)
        self.assertIn("长度不能少于5位", result.get_error_messages())
    ...
    def test_create_pattern_validator(self):
        ...
        self.assertFalse(result.is_valid)
        self.assertIn("只能包含数字", result.get_error_messages())
    ...
    def test_create_enum_validator(self):
        ...
        result = validator("D")
        self.assertFalse(result.is_valid)
        self.assertIn("必须是以下值之一", result.get_error_messages())
    ...
    def test_create_range_validator(self):
        ...
        result = validator("5")
        self.assertFalse(result.is_valid)
        self.assertIn("不能小于10", result.get_error_messages())
    ...
    def test_create_custom_validator(self):
        ...
        result = validator("123")
        self.assertFalse(result.is_valid)
        self.assertIn("长度不足", result.get_error_messages())
